  ...
  return (
    <WorkspaceShell>
      ...
      {showCreateModal ? (
        ...
        >
          <div className="w-full max-w-2xl rounded-2xl border border-border/70 bg-white p-6 shadow-2xl animate-in zoom-in-95 slide-in-from-bottom-2 duration-200 ease-out">
